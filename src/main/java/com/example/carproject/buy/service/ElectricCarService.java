...
public class ElectricCarService {
    ...
    // ========================================================
    public Map<String, Object> getFilterCounts(ElectricFilterRequest filters) {
        ...
        if (selectedMaker != null) {
            map.put("modelsForMaker", facetRepo.countModelsByMaker(selectedMaker));
        }
        if (selectedMaker != null && selectedModel != null) {
            map.put("carNamesForModel",
                    facetRepo.countCarNamesByMakerAndModel(selectedMaker, selectedModel));
        }
        return map;
    }
