...
@Repository
public interface CargoSpecialSaleRepository extends JpaRepository<CargoSpecialSale, Integer>, JpaSpecificationExecutor<CargoSpecialSale> {
    ...
    @Query("SELECT c.bodyType AS val, COUNT(c) AS cnt FROM CargoSpecialSale c GROUP BY c.bodyType")
